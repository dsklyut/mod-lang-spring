...
class SpringContextInitializer extends Verticle {
  ...
  public static final String APP_CONTEXT_SD_KEY = "__vertx.langs.spring.AppContexts";
  public static final String DEFAULT_USE_PARENT_CONTEXT_OPTION = VertxApplicationContext.UseParentContext.NONE.name();
  ...
  private void onStart() throws Exception {
    ...
    if (this.context == null) {
      this.context = findOrCreateContext(config);
    }
    ...
    if (!this.context.isActive()) {
      ...
      if (this.context.getParent() == null) {
        ...
        ApplicationContext parent = findParentContext(config);
    ...
    if (field != null) {
      if (field instanceof String) {
        ...
        for (Object c : ((JsonArray) field)) {
          classNames.add(String.valueOf(c));
        }
      }
    }
